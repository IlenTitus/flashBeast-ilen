...
function preload() {
  ...
  bgimg = loadImage('background11.PNG')
  groundimage = loadImage('ground.png')
  playerimage = loadImage('boy3.png')
  playerimage2 = loadImage('boy3-flip.png')

  enemyimage1 = loadImage('enemy.png')
  enemyimage2 = loadImage('enemy1.png')
  enemyimage3 = loadImage('enemy4.gif')


  coinimage = loadAnimation('coin/1.png', 'coin/2.png', 'coin/3.png', 'coin/4.png', 'coin/5.png', 'coin/6.png', 'coin/7.png', 'coin/8.png', 'coin/9.png', 'coin/10.png')
}
...
function setup() {
  ...
  playButton.position(width / 3.5, height / 1.75)
  playButton.size(150, 150)

  aboutButton = createImg("about1.png")
  //aboutButton=createButton('About');
  aboutButton.position(width /1.75, height / 1.7)
  aboutButton.size(155, 130)
  ...
  ground.visible = false
    // ground.debug = true
    ground.setCollider("rectangle",0,-10,ground.width,ground.height/2)
...
function draw() {
  ...
  if (gameState == "play") {
    ...
    text('TREASURE :  ' + coinsl1, width - 200 - 100, 50)
  ...
  if (gameState == "level2") {
    ...
    text('TREASURE :  ' + coinsl2, width - 200 - 100, 50)
